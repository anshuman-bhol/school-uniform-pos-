...
const pendingCount = pendingOrders.length;
  ...
  return (
    <section className='bg-[#000000] h-[calc(100vh-5rem)] overflow-hidden flex gap-3'>
      <div className='flex-3 bg-black h-148 overflow-hidden'>
        <Greetings />
      ...
      <div className='flex-2'>
        <TopSelling className='h-[calc(100vh-8rem)]' />
      </div>
      <BottomNav/>
    </section>
  )
