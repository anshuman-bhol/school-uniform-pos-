...
const Metrics = () => {
    return (
        <div className="container mx-auto py-2 px-6 md:px-4 h-full overflow-auto scrollbar-none">
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="font-semibold text-[#f5f5f5] text-xl">Overall Performance</h2>
                    <p className="text-sm text-[#ababab]">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum, saepe.</p>
                </div>
            ...
            <div className="flex flex-col justify-between mt-12">
                <div>
                    <h2 className="font-semibold text-[#f5f5f5] text-xl">Items Details</h2>
                    <p className="text-sm text-[#ababab]">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum, saepe.</p>
                </div>
                <div className="mt-6 grid grid-cols-4 gap-4">
                    {
